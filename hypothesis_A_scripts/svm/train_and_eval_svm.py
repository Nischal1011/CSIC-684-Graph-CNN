...
# --- Main Experiment Script for Support Vector Machine (SVM) ---

if __name__ == "__main__":
    # --- Configuration ---
    # These are the "golden" hyperparameters found from the tuning script
    TUNED_PARAMS = {
        'C': 0.001, # <-- UPDATE THIS FROM tune_svm.py
